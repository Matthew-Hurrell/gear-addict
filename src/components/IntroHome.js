    ...
    <section className='bg-slate-50 px-5 py-12 lg:py-24'>
      <div className='container mx-auto'>
        ...
        <p className="max-w-4xl mx-auto text-base lg:text-lg">
          ...
          add and catalogue your music gear, and organise it according to your preferences.
          You can also showcase your live performance gear set ups, share them with other users,
          and discover new ideas and inspirations from fellow musicians. With Gear Addict, you can
          focus on what matters most - making music and enjoying the gear that fuels your creativity.
        </p>
      </div>
    </section>
  )
